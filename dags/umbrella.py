...
clean_forecast_data = BashOperator(task_id="clean_forecast_data",bash_command='echo "fetch_weatger_forecast"', dag=dag)
join_datasets = BashOperator(task_id="join_datasets",bash_command='echo "fetch_weatger_forecast"', dag=dag)
